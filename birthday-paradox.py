"""Birthday Paradox Simulation - Explore the surprising probabilities of the
'Birthday Paradox'.
"""
...
def getMatch(birthdays):
    """Returns the date object of a birthday that occurs more than once in the
    birthdays list.

    Args:
        birthdays (string[]): list of birthdays
    """
